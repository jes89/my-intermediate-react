...
### when I send a lot of props to subcompoents, I need to send useless props from root js to some of their parent in the parent components. it is one of ways to damage the readability of the code. In addition, the root js have to have all of date what will be used by its children components. I can prevent this case by using Redux. 
